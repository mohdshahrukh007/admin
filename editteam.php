		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
			      ...
			      include("connect.php");
				  mysqli_query($con,"update team set tname='$tname',position='$position',photo='$photo',status=1 where id=$id");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                         Welcome to the team dashboard ! Feel free to edit team section. 
                        <br />
		 ...
		 <!-- start banner Area -->
			...
			<section class="info-area pb-40">
				<div class="container-fluid">
				    <div class="col-md-12">
					  ...
					  <?php
							include("connect.php");
							$id=$_GET['data_id'];
							$result=mysqli_query($con,"select * from team where id=$id and status=1");
				...
				<tr>
					<td>Position:</td>
					<td>
						<input type="text" name="position" id="position" class="form-control" data-validation="required" value="<?php echo $row['position']?>">
					</td>
				</tr>
