		 ...
		 if(isset($_POST['submit']))
			{   
				if($condition==1)
				{
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into slider(title,description,photo,status) values('$title','$description','$photo','$status')");
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        ...
                        Welcome to the Slider Portion, Here you can easily manage the slider. 
						<br />
