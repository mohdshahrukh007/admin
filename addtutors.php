		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into tutors(tname,subject,photo,description,status) values('$tname','$subject','$photo','$description','$status')");
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        ...
                        Welcome to the Tutors Portion, Here you can easily manage the tutors.
						<br />
