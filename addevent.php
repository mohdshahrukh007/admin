		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into event(title,description,photo,date,status) values('$name','$description','$photo','$date','$status')");
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        ...
                        Welcome to event portion. Her you can easily modify the upcomming and past events. 
                        <br />
...
<!-- start banner Area -->
			...
			<section class="info-area pb-40">
				...
				<tr>
					...
					id="date" data-validation="required"></td>
				</tr>
