					  ...
					  <form method="POST" action="" enctype = "multipart/form-data">
						...
						<table class="table">
								...
								<tr>
									...
									<td>
										<input type="text" name="date" id="date" class="form-control" data-validation="required" value="<?php echo ($row['date']);?>">
									</td>
								</tr>
								...
								<tr>
									<td>Upload Image</td>
										<td><input class="btn btn-success" type="file"  name="image" data-validation="required">
										&nbsp;&nbsp;
